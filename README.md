...
├── internal_guide/
│   └── PANDUAN.md           # Internal technical guide (Bahasa Indonesia)
├── styles/
...
> See [PANDUAN.md](./internal_guide/PANDUAN.md) for the full technical guide in Bahasa Indonesia,
> including privacy controls, `noindex` usage, and `robots.txt` maintenance.
